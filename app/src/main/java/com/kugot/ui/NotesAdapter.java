...
public class NotesAdapter extends RecyclerView.Adapter<com.kugot.ui.NotesAdapter.ViewHolder> {
    private Note[] notes;
    ...
    @NonNull
    @Override
    public com.kugot.ui.NotesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull com.kugot.ui.NotesAdapter.ViewHolder holder, int position) {
